...
Ext.onReady(function () {
   ...
   var gridPanelAll = Ext.create('Ext.grid.Panel', {
   ...
   var gridPanelOpen = Ext.create('Ext.grid.Panel', {
   ...
   var gridPanelClosed = Ext.create('Ext.grid.Panel', {
   ...
   Ext.create('Ext.TabPanel', {
    	...
    	items: [{
    		xtype: 'tabpanel',
    		title: 'Invoices',
    		items: [gridPanelAll, gridPanelOpen, gridPanelClosed]
    	}]
	});
